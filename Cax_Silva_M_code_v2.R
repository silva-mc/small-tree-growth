...
data = read.csv("Cax_Silva_M_data_v2.csv") # Small tree DBH timeseries
data_larg = read.csv("Cax_Silva_M_data_larg_v2.csv") # Large tree DBH timeseries
data_rgr = read.csv("Cax_Silva_M_data_rgr_v2.csv") # Individual-level stem increment
data_rgr_avg = read.csv("Cax_Silva_M_data_rgr_avg_v2.csv") # Species-averaged stem increment
data_subp = read.csv("Cax_Silva_M_data_subp_v2.csv") # Subplot-averaged stem increment
data_subp_long = read.csv("Cax_Silva_M_data_subp_long_v2.csv") # Subplot species richness and invidual density
data_trai_pca = read.csv("Cax_Silva_M_data_trai_pca_v2.csv") # Species-level stem increment, traits and PCA axes
data_trai_pca_delt = read.csv("Cax_Silva_M_data_trai_pca_delt_v2.csv") # Species-level delta stem increment, traits and PCA axes
pca_scores = read.csv("Cax_Silva_M_pca_scores_v2.csv") # PCA scores
pca_loadings = read.csv("Cax_Silva_M_pca_loadings_v2.csv") # PCA loadings
coef_all = read.csv("Cax_Silva_M_coef_all_v2.csv") # LMM coefficients
pca = readRDS("Cax_Silva_M_pca_v2.rds") # PCA
